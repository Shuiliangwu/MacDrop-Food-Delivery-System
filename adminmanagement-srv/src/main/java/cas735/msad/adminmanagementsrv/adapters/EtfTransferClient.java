...
import cas735.msad.adminmanagementsrv.dto.EtfTransferResponse;
import cas735.msad.adminmanagementsrv.ports.EtfTransferService;
...
public class EtfTransferClient implements EtfTransferService {
    ...
    private String locateExternalService() {
        ...
        if (Objects.isNull(candidates)) { // no EtfTransfer service in the registry
            throw new IllegalStateException();
        }
        Random rand = new Random();
        InstanceInfo infos = // Randomly picking one EtfTransfer service among candidates
