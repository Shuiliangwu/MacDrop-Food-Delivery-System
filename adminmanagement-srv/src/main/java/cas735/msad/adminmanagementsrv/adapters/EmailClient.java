...
import cas735.msad.adminmanagementsrv.dto.EmailResponse;
import cas735.msad.adminmanagementsrv.ports.EmailService;
...
public class EmailClient implements EmailService {
    ...
    public void send(EmailRequest req) {
        log.info("** Preparing sending billing statement");
        try {
            ...
            log.error("Communication Error while sending billing statement");
